...
const listProjects = ref([
  {
    title: 'PODYAI',
    description:
      'An AI Video Production platform for global e-commerce. Built with Vue 3 and Nuxt 3, it features optimized HD video rendering and seamless Generative AI workflows for thousands of sellers.',
    icon: 'i-mdi-github',
    images: [
      new URL('@/assets/images/pody-2.png', import.meta.url).href,
      new URL('@/assets/images/pody-3.png', import.meta.url).href,
      new URL('@/assets/images/pody-4.png', import.meta.url).href,
    ],
  },
  {
    title: 'QUIZZFLY',
  ...
  },
  {
    title: 'CV.MAKER',
    description:
      'A CV builder and analyzer powered by AI. This project helps users create, edit, and evaluate their resumes with automated quality scoring.',
    icon: 'i-mdi-github',
    images: [
...
<template>
  <div
    ref="elementRef"
    class="flex flex-col gap-4 sm:gap-6 md:gap-8 justify-center items-center pb-12 sm:pb-16 md:pb-20 lg:pb-[80px] w-full"
  >
    <div class="bg-[#161513] w-full bg-dark-dots px-4 sm:px-8 md:px-12 lg:px-20">
      <div
        :class="[
          'pb-12 sm:pb-16 md:pb-20 lg:pb-[80px] pt-8 sm:pt-12 md:pt-16 lg:pt-[40px]',
          isVisible ? 'animate-slideInLeft' : 'opacity-0',
        ]"
      >
        <h3 class="text-gradient font-medium text-sm sm:text-base md:text-[18px] text-left">
          My impressive projects
        </h3>
        <div class="flex justify-center sm:justify-start flex-col items-start relative w-full">
          <h1
            class="text-white text-[24px] sm:text-[28px] md:text-[32px] font-bold z-[99] absolute"
          >
            Projects
          </h1>
        ...
        <p
          class="text-white font-medium my-4 sm:my-6 w-full sm:w-[350px] md:w-[400px] text-sm sm:text-base text-left"
        >
          Built as a skill-sharpening experiment, this side project might surprise you. Let's
          discover it!
        </p>
        <div class="flex justify-start">
          ...
          >
            <span>See more</span>
            <Icon
              name="i-ic-round-read-more"
              class="!h-5 !w-5 sm:!h-6 sm:!w-6 text-white ml-2 sm:ml-3"
            />
          </a>
        </div>
      </div>
    ...
    <div
      class="px-4 sm:px-8 md:px-12 lg:px-20 flex flex-col lg:flex-row justify-between gap-8 sm:gap-12 md:gap-16 lg:gap-24 w-full mt-8 sm:mt-6 md:mt-8"
    >
      <!-- List Projects -->
