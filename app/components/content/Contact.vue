...
<template>
  <div ref="elementRef" class="flex flex-col gap-4 justify-center items-start py-[80px] bg-[#161513] w-full bg-dark-dots px-20">
    ...
    <div class="flex gap-16 h-full mt-8">
        <div class="w-[1px] bg-[#2b2926] self-stretch"></div>
        <div class="text-stone-300 space-y-12 w-[70%]">
            <!-- Note -->
            ...
            <section class="space-y-4">
                <h2 class="text-2xl font-bold tracking-tight text-stone-100">Contact</h2>
        
                <div class="overflow-hidden rounded-xl border border-[#2b2926]">
                <table class="w-full text-sm">
                    ...
                    <tr class="border-b border-[#24221f] hover:bg-[#1a1815]/60 transition">
                        <td class="px-4 py-3 text-stone-400">Address</td>
                        <td class="px-4 py-3">DaNang, VietNam</td>
                    </tr>
                    <tr class="border-b border-[#24221f] hover:bg-[#1a1815]/60 transition">
                        <td class="px-4 py-3 text-stone-400">Timezone</td>
                        <td class="px-4 py-3">GMT+7</td>
                    </tr>
                    <tr class="hover:bg-[#1a1815]/60 transition">
                        <td class="px-4 py-3 text-stone-400">E-mail</td>
                        <td class="px-4 py-3 flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path d="M4 4h16v16H4z" stroke-width="1.5" />
                            <path d="M4 7l8 6 8-6" stroke-width="1.5" />
                        </svg>
                        <a href="mailto:dbluework0811@gmail.com"
                            class="underline underline-offset-2 text-sky-300 hover:text-sky-200 transition">
            ...
            <!-- Social Media -->
            <section class="space-y-4">
                <h2 class="text-2xl font-bold tracking-tight text-stone-100">Social Media</h2>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                    <tr class="border-b border-[#24221f] hover:bg-[#1a1815]/60 transition">
                        <td class="px-4 py-3 text-stone-400">Github</td>
                        <td class="px-4 py-3">
                        <a href="https://github.com/trungdong11" target="_blank"
                            class="inline-flex items-center gap-1 underline underline-offset-2 text-sky-300 hover:text-sky-200">
                    ...
                    <tr class="border-b border-[#24221f] hover:bg-[#1a1815]/60 transition">
                        <td class="px-4 py-3 text-stone-400">LinkedIn</td>
                        <td class="px-4 py-3">
                    ...
                    <tr class="hover:bg-[#1a1815]/60 transition">
                        <td class="px-4 py-3 text-stone-400">Instagram</td>
                        <td class="px-4 py-3">
